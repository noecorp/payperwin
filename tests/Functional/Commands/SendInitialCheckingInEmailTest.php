...
use App\Commands\SendInitialCheckingInEmail as Command;
use App\Contracts\Repository\Users;
use Illuminate\Contracts\Bus\QueueingDispatcher;
use Illuminate\Contracts\Queue\Queue;

/**
 * @coversDefaultClass \App\Commands\SendInitialCheckingInEmail
 */
class SendInitialCheckingInEmailTest extends \AppTests\TestCase {
	...
	public function test_handle()
	{
		...
		$this->assertContains(view('emails.checking-in',['username'=>'bar','code'=>'foobar'])->render(), $logs);
	}
