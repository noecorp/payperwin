	...
	<div class="row">
		...
		<div class="col-xs-12 col-sm-5 col-sm-offset-2">
				...
				<form role="form" method="PUT" action="/users/{{ $user->id }}" id="streaming-form">
					...
					@else
						...
						@else
							...
							<div class="form-group">
								<p><strong>Coming soon:</strong> You'll soon be able to add all of your accounts rather than just your main one.</p>
							</div>
						@endif
			...
			@if ($user->twitch_id && $user->summoner_id)
				...
				<section class="edit-profile">
					<h2>Affiliate</h2>
					<p>Invite other streamers and get a slightly lower commission for every streamer that registers with your affiliate link and completes their PayPerWin profile! Your unique affiliate URL is:</p>
					<div class="alert alert-info">
